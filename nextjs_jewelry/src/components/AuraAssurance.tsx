        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-6">
            {badges.map((badge, idx) => (
              ...
              >
                <div 
                  className="flex flex-col items-center p-6 bg-white border border-[#e5dcd3] rounded-2xl text-center shadow-sm hover:border-[#0EA5E9]/35 transition-all duration-300 group h-full justify-center"
                >
