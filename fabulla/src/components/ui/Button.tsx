...
const base =
  ...
  // single line at desktop. Shape lock = 2px radius, no pills.
...
const variants: Record<Variant, string> = {
  // Rose ground with ink text: 9.1:1. Passes AA comfortably.
  primary:
    "bg-rose text-ink px-7 py-3.5 font-medium hover:bg-rose-soft",
  // Bone text on ink ground through a visible stroke: 15.8:1.
  outline:
