 ...
 * right. The reference build's closing editorial block.
 *
 * The reference's card had an infinitely pulsing ring behind it. It sat on a
 * static section and communicated nothing, so it is gone; the card holds on
 * its own.
 */
...
const FEATURES = [
  {
    ...
    body: "Every stone arrives with its GIA or IGI grading report and laser inscription.",
  },
  {
    Icon: Hammer,
    title: "Set by hand",
    body: "Claw and pave work done at the bench in platinum and solid gold, never cast-and-drop.",
  },
  {
    Icon: ShieldCheck,
    title: "Sourced through Surat",
    body: `Direct access to the hub that cuts ${METRICS.diamondsFromSurat} of the world's diamonds.`,
  },
  {
    Icon: Heart,
    title: "Cared for after",
    body: "Cleaning, prong tightening and resizing for the life of the piece.",
  },
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <Reveal>
              ...
              <h2
                id="craft-heading"
                className="display mt-4 max-w-xl text-[clamp(2rem,4vw,3.1rem)] text-ink"
              >
              ...
              <p className="mt-6 max-w-2xl font-sans text-[14.5px] leading-relaxed text-ink-2">
                Fabulla is built on generations of craftsmanship rooted in{" "}
                {SITE.origin}, paired with a bench in {SITE.city}. Stones are
                vetted, graded and hand-set, and the person who designs your
                piece is the person who builds it.
              </p>
            </Reveal>
          ...
          <Reveal index={2} className="lg:col-span-5">
            <div className="relative mx-auto flex aspect-square w-full max-w-[400px] flex-col justify-between overflow-hidden rounded-3xl border border-line p-8 shadow-[0_10px_40px_rgba(15,23,42,0.06)]">
              ...
              <div className="relative z-10 flex items-start justify-between">
                <span className="font-mono text-[9.5px] uppercase tracking-[0.24em] text-ink">
              ...
              <div className="relative z-10 py-6 text-center">
                <span className="display block text-[56px] leading-none text-ink">
                  100%
                </span>
                <p className="display mt-3 text-[19px] text-ink">
                  Certified and traceable
                </p>
                <p className="mx-auto mt-4 max-w-[280px] font-sans text-[12.5px] leading-relaxed text-ink-3">
                  Every purchase arrives with its grading report, inscription
                  verification and appraisal for insurance.
                </p>
              </div>
